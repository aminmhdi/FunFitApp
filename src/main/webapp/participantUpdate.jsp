		...
		<div class="p-3">
			<div class="card">
				<div class="card-header">
              		<h5 class="m-0">Edit participant</h5>
				</div>
				<div class="card-body">
					<form>
							...
							<div class="row">
								<input type="hidden" name="pid" value="${sessionScope.participant.getPid()}" />
								  <div class="col-md-6 col-lg-3 mb-3">
									...
									<input type="text" class="form-control" name="fname" value="${sessionScope.participant.getFname()}">
								  </div>
								  <div class="col-md-6 col-lg-3 mb-3">
									<label class="label">Lastname</label>
									<input type="text" class="form-control" name="lname" value="${sessionScope.participant.getLname()}">
								  </div>
								  <div class="col-md-6 col-lg-3 mb-3">
									<label class="label">Age</label>
									<input type="number" class="form-control" name="age" value="${sessionScope.participant.getAge()}">
								  </div>
								  <div class="col-md-6 col-lg-3 mb-3">
									<label class="label">Phone</label>
									<input type="text" class="form-control" name="phonenumber" max="10" value="${sessionScope.participant.getPhonenumber()}">
								  </div>
								  <div class="col-md-6 col-lg-3 mb-3">
